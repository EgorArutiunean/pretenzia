...
class Settings:
    ...
    court_orders_base_data_path: Path | None
    court_orders_jurisdiction_path: Path | None
...
def load_settings(*, require_bot: bool = False) -> Settings:
    ...
    settings = Settings(
        ...
        court_orders_base_data_path=_resolve_optional_path(
            os.getenv("COURT_ORDERS_BASE_DATA_PATH")
            or os.getenv("COURT_ORDERS_STATIC_DATA_PATH")
        ),
        court_orders_jurisdiction_path=_resolve_optional_path(
            os.getenv("COURT_ORDERS_JURISDICTION_PATH")
        ),
